...
import HeroTabsLaptop from "@/components/hero-tabs-laptop";
...
const features = [
  {
    ...
    desc: "Take dine-in, takeaway and delivery orders from one screen.",
  },
  {
    key: "kitchen",
  ...
  },
  {
    ...
    desc: "Know what's running low before you run out.",
  },
  {
    key: "billing",
    title: "Billing & Invoicing",
    desc: "GST-ready bills and invoices, generated automatically.",
  },
  {
    key: "payment",
    title: "Payment Collection",
    desc: "Accept cash, cards and UPI without extra hardware.",
  },
  {
    key: "staff",
    title: "Staff Roles & Access",
    desc: "Give each team member exactly the access they need.",
  },
  {
    key: "analytics",
    title: "Sales Analytics",
    desc: "Track sales, best-sellers and peak hours in real time.",
  },
  {
    key: "mobile",
    title: "Owner Mobile Dashboard",
    desc: "Check on your café from anywhere, any time.",
  },
];

const valueProps = [
  {
    title: "Built for cafés",
    desc: "Designed around café-speed service, not generic enterprise workflows.",
  },
  {
    title: "One system",
    desc: "Orders, kitchen, inventory, billing and staff   together, not stitched.",
  },
  {
    title: "Live in days",
    desc: "Menu migration and setup handled for you before launch.",
  },
...
const steps = [
  { n: "1", title: "Book a demo", desc: "30 minutes, no commitment." },
  {
    ...
    desc: "Menu, pricing and inventory moved over for you.",
  },
  {
    n: "3",
    title: "Team onboarding",
    desc: "Your staff trained in a single session.",
  },
  { n: "4", title: "Go live", desc: "Start running your café on Servio." },
];

export default function ServioLandingV4() {
  return (
    <div
    ...
    >
          ...
          <div className="relative grid items-start gap-14 md:grid-cols-2">
            <div className="space-y-8">
              ...
              <p className="inter max-w-md text-lg leading-8 text-neutral-400">
                Minimalist software built for modern cafés orders, kitchen,
                inventory and billing, in one place.
              </p>
      ...
      <div className="mx-auto max-w-6xl px-6 md:px-12">
        {/* Momentum bar */}
        <MotionReveal rotate={2}>
          <section className="mt-16 grid grid-cols-1 gap-6 rounded-2xl border border-neutral-300 bg-white px-8 py-8 sm:grid-cols-3">
            <div>
              <p
                className="instrument text-4xl"
      ...
      {/* BIG scroll-pinned showcase   laptop tilts flat, phone slides in, tied to scroll */}
      <ScrollShowcase />
      ...
      <div className="mx-auto max-w-6xl px-6 md:px-12">
        ...
        <MotionReveal>
          <section className="mt-10 grid gap-10 md:grid-cols-2">
            ...
            <div className="space-y-5 inter text-neutral-600 leading-7">
              ...
              <p>
                Instead of stitching together multiple tools, everything lives
                in one place.
              </p>
            </div>
          </section>
            ...
            {features.map((f, i) => (
              ...
              >
                <div className="h-full rounded-2xl border border-neutral-200 bg-white p-6 transition hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <h3 className="inter mt-4 font-medium text-neutral-900">
                    {f.title}
                  </h3>
                  <p className="inter mt-1.5 text-sm leading-6 text-neutral-500">
                    {f.desc}
                  </p>
                </div>
              </MotionReveal>
        ...
        {/* Flagship rows   laptop-framed mockups */}
        <section className="mt-24 space-y-24">
          <MotionReveal rotate={-3}>
            <div className="grid items-center gap-10 md:grid-cols-2">
              <div>
                <p
                  className="inter text-xs font-semibold uppercase tracking-[0.2em]"
                  style={{ color: "var(--accent)" }}
                >
                  Front of house
                </p>
                <h3 className="instrument mt-3 text-3xl text-neutral-900">
                  Orders and tables, in sync.
                </h3>
                <p className="inter mt-4 max-w-md leading-7 text-neutral-600">
                  Every order dine-in, takeaway or delivery lands in one queue.
                  Table status updates the moment a bill is settled.
                </p>
              </div>
              <LaptopFrame>
        ...
        <MotionReveal>
          <section className="mt-24 border-t border-neutral-300 pt-14">
            <h2 className="instrument text-4xl text-neutral-900">
              Why cafés choose Servio.
            </h2>
            <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {valueProps.map((v, i) => (
                <div key={v.title}>
                  ...
                  <h4 className="inter mt-2 font-medium text-neutral-900">
                    {v.title}
                  </h4>
                  <p className="inter mt-1.5 text-sm leading-6 text-neutral-500">
                    {v.desc}
        ...
        <MotionReveal>
          <section className="mt-24 border-t border-neutral-300 pt-14">
            ...
            <div className="mt-10 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
              {steps.map((s) => (
                <div key={s.n}>
                  <span className="instrument text-2xl text-neutral-300">
                    {s.n}
                  </span>
                  <h4 className="inter mt-2 font-medium text-neutral-900">
                    {s.title}
        ...
        {/* Footer */}
        <footer className="mt-24 flex items-center justify-between border-t border-neutral-300 pt-8 pb-10 inter text-sm text-neutral-500">
          <p>© 2026 Servio</p>
          <p>
