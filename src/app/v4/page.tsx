...
export default function ServioLandingV4() {
  return (
    ...
    >
      ...
      {/* Continuous screenshot marquee — ADKO-style motion strip, full bleed */}
      <div className="mt-10 border-y border-neutral-300 bg-white/60">
        <ScreenMarquee />
      </div>
      ...
      <div className="mx-auto max-w-6xl px-6 md:px-12">
        ...
        <section className="mt-20 border-t border-neutral-300 pt-10">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f, i) => (
              <MotionReveal key={f.key} delay={(i % 3) * 80} rotate={(i % 2 === 0 ? 1 : -1) * 3}>
        ...
        <MotionReveal>
          <section className="mt-24 border-t border-neutral-300 pt-14">
            ...
            <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {valueProps.map((v, i) => (
                <div key={v.title}>
                  <span className="instrument text-2xl" style={{ color: "var(--accent)" }}>
